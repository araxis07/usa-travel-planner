    ...
    <div className="daily-planner">
        ...
        <label>
          ...
          <select
            ...
            onChange={(event) => {
              ...
              setDay(1);
              setSelection(`${event.target.value}-0`);
            }}
          >
            {trip.stops.map((s) => (
      ...
      >
        ...
        <label>
          ...
          <input
            ...
            value={minutes}
            onChange={(event) =>
              setMinutes(Math.max(15, Math.min(720, Math.round(Number(event.target.value) || 15))))
            }
          />
        </label>
      ...
      {!!today.length && (
        <>
          ...
          <RouteMap points={points} lang={lang} routing activityMinutes={total} />
